...
const AdminCard = ({ ticket, onDelete, onUpdate }) => {
  ...
  return (
    <div className={`relative border rounded-2xl p-5 shadow-lg hover:shadow-2xl transition duration-300 bg-white flex flex-col gap-3 w-full lora h-full min-h-[300px] max-h-[400px] overflow-hidden ${getborderColor(ticket.priority)}`}
